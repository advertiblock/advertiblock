...
let UI = exports.UI =
{
  ...
  {
    console.log('ui addSubscription');
    ...
    if (FilterStorage.subscriptions.some((subscription) => subscription.url == Prefs.subscriptions_especialurl))
      addEspecial = false;

    if(addEspecial) {
      let especialSubscription = Subscription.fromURL(
        Prefs.subscriptions_especialurl
      );

      if(especialSubscription) {
        especialSubscription.title = "Espacial";
  ...
  {
    console.log('toggleAcceptableAds');
    // let subscription = Subscription.fromURL(Prefs.subscriptions_exceptionsurl);
    // if (!subscription)
    //   return false;
